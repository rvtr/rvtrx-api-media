...
namespace RVTR.Media.Testing.Tests
{
  public class MediaModelTest
  {
    ...
    {
      MediaModel media = new MediaModel(){Group = "profile", GroupIdentifier = "your.name@email.com", Uri = "https://notblobstorage/%22", AltText="hat"};
    ...
    {
      MediaModel media = new MediaModel(){MediaId = 12345, Group = "profile", Uri = "https://notblobstorage/%22", AltText="hat"};
    ...
    {
      MediaModel media = new MediaModel(){MediaId = 12345, Group = "profile", GroupIdentifier = "your.name@email.com",  AltText="hat"};
    ...
    {
      MediaModel media = new MediaModel(){MediaId = 12345, Group = "profile", GroupIdentifier = "your.name@email.com", Uri = "https://notblobstorage/%22"};
    ...
    {
      MediaModel mediaProfile = new MediaModel(){MediaId = 12345, Group = "profile", GroupIdentifier = "your.name@email.com", Uri = "https://notblobstorage/%22",  AltText="hat"};
      MediaModel mediaCampground = new MediaModel(){MediaId = 12345, Group = "campground", GroupIdentifier = "your.name@email.com", Uri = "https://notblobstorage/%22",  AltText="hat"};
      MediaModel mediaCampsite = new MediaModel(){MediaId = 12345, Group = "campsite", GroupIdentifier = "your.name@email.com", Uri = "https://notblobstorage/%22",  AltText="hat"};
    ...
    {
      MediaModel media = new MediaModel(){MediaId = 12345, Group = "profile", GroupIdentifier = "your.name@email.com1", Uri = "https://notblobstorage/%22",  AltText="hat"};
    ...
    {
      MediaModel media = new MediaModel(){MediaId = 12345, Group = "profile", GroupIdentifier = "campground111", Uri = "https://notblobstorage/%22",  AltText="hat"};
    ...
    {
      MediaModel media = new MediaModel(){MediaId = 12345, Group = "profile", GroupIdentifier = "campground-111", Uri = "https://notblobstorage/%22",  AltText="hat"};
